...
Acá mostrare una adaptación con **tidyverse**[^note1]de uno de los primeros blogs con contenido de R que revise escrito por **Sean Kross**[^note2]. 
...
[^note1]: [Tidyverse](https://www.tidyverse.org/).
[^note2]: Basado en **A Short Intro to Confidence Intervals** por [Sean Kross](http://seankross.com/).
