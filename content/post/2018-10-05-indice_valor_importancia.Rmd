...
Para reproducir el presente podrás acceder a la base de datos desde el siguiente enlace: [(data)](https://github.com/PaulESantos/tutoriales/blob/master/ivi_data.csv)
